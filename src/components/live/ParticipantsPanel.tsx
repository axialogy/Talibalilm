...
import { Hand, Mic, MicOff, MonitorUp, UserMinus, Video, VideoOff } from 'lucide-react';
            ...
            <>
              ...
              <div className="mt-2 flex items-center gap-1">
                ...
                >
                  ...
                  <span className="sr-only">{person.micOn ? t('muteThem') : t('unmuteThem')}</span>
                </button>
                ...
                >
                  ...
                  <span className="sr-only">{t('allowScreen')}</span>
                </button>
